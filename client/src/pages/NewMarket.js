                  ...
                  <form>
                    <fieldset>
                      <div className="form-row">
                        <div className="form-group col-md-12">
                          ...
                          <input
                            ...
                            value={this.state.fields["marketName"]}
                      ...
                      <div className="form-row">
                        <div className="form-group col-md-12">
                          <label>
                            Link to an image of your garden or market:
                          </label>
                          <input
                            className="form-control"
                            name="img"
                      ...
                      <div className="row">
                        <div className="col">
                          ...
                          <select
                            ...
                            id="startMonth"
                            value={this.state.fields["startMonth"]}
                            onChange={this.handleChange.bind(
                              this,
                              "startMonth"
                            )}
                        ...
                        <div className="col">
                          ...
                          <select
                            ...
                            className="custom-select my-1 mr-sm-2"
                            id="endMonth"
                            value={this.state.fields["endMonth"]}
                            onChange={this.handleChange.bind(this, "endMonth")}
                          >
                            <option>Choose...</option>
                            <option value="January">January</option>
                            <option value="February">February</option>
...
export default connect(mapStateToProps)(NewMarket);
